...
_DEFINITIONS = (
    _definition("takeoff", TakeoffAction, "Arm, issue TAKEOFF, then lock the FIELD-centre heading during the climb.",
                {"mode": "GUIDED", "altitude_m": 4.5, "altitude_tolerance_m": 0.35, "require_armed": True, "max_updates": 150, "max_duration_s": 45, "yaw_mode": "field_heading", "takeoff_yaw_deg": None, "yaw_tolerance_deg": 5.0, "yaw_min_hold_updates": 2, "yaw_timeout_s": 12.0, "yaw_speed_deg_s": 20.0, "priority": 2, "arm_priority": 1, "mode_priority": 2},
                properties={"mode": {"type": "string", "enum": ["GUIDED"]}, "altitude_m": {"type": "number", "exclusiveMinimum": 0}, "target_alt_m": {"type": "number", "exclusiveMinimum": 0}, "altitude_tolerance_m": {"type": "number", "exclusiveMinimum": 0}, "max_updates": {"type": "integer", "minimum": 1}, "max_duration_s": {"type": ["number", "null"], "exclusiveMinimum": 0}, "yaw_mode": {"type": "string", "enum": ["field_heading", "hold"]}, "takeoff_yaw_deg": {"type": ["number", "null"]}, "field_yaw_deg": _NUMBER, "yaw_deg": _NUMBER, "yaw_tolerance_deg": {"type": "number", "exclusiveMinimum": 0, "maximum": 180}, "yaw_min_hold_updates": {"type": "integer", "minimum": 1}, "yaw_timeout_s": {"type": "number", "exclusiveMinimum": 0}, "yaw_speed_deg_s": {"type": "number", "exclusiveMinimum": 0}, "require_armed": _BOOLEAN, "priority": _INTEGER, "arm_priority": _INTEGER, "mode_priority": _INTEGER, "key": _STRING},
    ...
    _definition(
        ...
        {"enabled": True, "complete_on_timeout": True, "target_altitude_m": 1.2, "descend_speed_mps": 0.3, "release_deadband_ex": 0.02, "release_deadband_ey": 0.02, "release_target_ex": 0.0, "release_target_ey": 0.0, "kp_forward": 0.3, "kp_right": 0.3, "ki_forward": 0.0, "ki_right": 0.0, "integral_limit": 0.25, "max_vx_mps": 0.25, "max_vy_mps": 0.25, "vx_sign": -1.0, "vy_sign": 1.0, "field_yaw_deg": 0.0, "yaw_speed_deg_s": 20.0, "priority": 5, "key": "drop_1_align"},
        properties={"enabled": _BOOLEAN, "complete_on_timeout": _BOOLEAN, "target_altitude_m": {"type": "number", "exclusiveMinimum": 0}, "descend_speed_mps": {"type": "number", "minimum": 0}, "release_deadband_ex": {"type": "number", "exclusiveMinimum": 0}, "release_deadband_ey": {"type": "number", "exclusiveMinimum": 0}, "release_target_ex": _NUMBER, "release_target_ey": _NUMBER, "priority": _INTEGER, "key": _STRING, "max_vx_mps": {"type": "number", "exclusiveMinimum": 0}, "max_vy_mps": {"type": "number", "exclusiveMinimum": 0}, "kp_forward": {"type": "number", "minimum": 0}, "kp_right": {"type": "number", "minimum": 0}, "ki_forward": {"type": "number", "minimum": 0}, "ki_right": {"type": "number", "minimum": 0}, "integral_limit": {"type": "number", "minimum": 0}, "vx_sign": {"type": "number", "enum": [-1, 1]}, "vy_sign": {"type": "number", "enum": [-1, 1]}, "field_yaw_deg": _NUMBER, "desired_yaw_deg": {"type": ["number", "null"]}, "yaw_speed_deg_s": {"type": "number", "exclusiveMinimum": 0}},
