...
_DEFINITIONS = (
    ...
    _definition("goto_waypoint", GotoWaypointAction, "Convert a FIELD target to GPS while holding yaw unless field-heading yaw is requested.",
                {"field_x_m": -3, "field_y_m": 31, "altitude_m": 4.5, "waypoint_mode": "field", "target_frame": "global", "yaw_mode": "hold", "tolerance_xy_m": 0.8, "tolerance_z_m": 0.6, "min_hold_updates": 8, "require_velocity_valid": True, "max_horizontal_speed_mps": 0.15, "max_vertical_speed_mps": 0.10, "priority": 5, "key": "drop_scan_goto_1"},
