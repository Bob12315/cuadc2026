...
_CAMERA = {"type": "object", "properties": {
    ...
    "ground_distance_scale": {"type": "number", "exclusiveMinimum": 0, "maximum": 1},
...
_DEFINITIONS = (
    _definition("takeoff", TakeoffAction, "Arm, issue TAKEOFF, then lock the FIELD-centre heading during the climb.",
                {"mode": "GUIDED", "altitude_m": 4.5, "altitude_tolerance_m": 0.35, "require_armed": True, "max_updates": 150, "max_duration_s": 45, "yaw_mode": "field_heading", "takeoff_yaw_deg": None, "yaw_tolerance_deg": 5.0, "yaw_min_hold_updates": 2, "yaw_timeout_s": 12.0, "yaw_speed_deg_s": 20.0, "settle_time_s": 1.0, "priority": 2, "arm_priority": 1, "mode_priority": 2},
                properties={"mode": {"type": "string", "enum": ["GUIDED"]}, "altitude_m": {"type": "number", "exclusiveMinimum": 0}, "target_alt_m": {"type": "number", "exclusiveMinimum": 0}, "altitude_tolerance_m": {"type": "number", "exclusiveMinimum": 0}, "max_updates": {"type": "integer", "minimum": 1}, "max_duration_s": {"type": ["number", "null"], "exclusiveMinimum": 0}, "yaw_mode": {"type": "string", "enum": ["field_heading", "hold"]}, "takeoff_yaw_deg": {"type": ["number", "null"]}, "field_yaw_deg": _NUMBER, "yaw_deg": _NUMBER, "yaw_tolerance_deg": {"type": "number", "exclusiveMinimum": 0, "maximum": 180}, "yaw_min_hold_updates": {"type": "integer", "minimum": 1}, "yaw_timeout_s": {"type": "number", "exclusiveMinimum": 0}, "yaw_speed_deg_s": {"type": "number", "exclusiveMinimum": 0}, "settle_time_s": {"type": "number", "minimum": 0}, "require_armed": _BOOLEAN, "priority": _INTEGER, "arm_priority": _INTEGER, "mode_priority": _INTEGER, "key": _STRING},
                parameter_aliases={"altitude_m": ("target_alt_m",), "field_yaw_deg": ("yaw_deg",)},
    ...
    _definition("change_speed", ChangeSpeedAction, "Set the flight-controller speed target.", {"speed_mps": 1.0, "speed_type": "ground", "priority": 4, "key": "drop_speed_1mps"},
    ...
    _definition("goto_waypoint", GotoWaypointAction, "Convert a FIELD target to GPS while facing FIELD +Y by default.",
                {"field_x_m": 0, "field_y_m": 32.5, "altitude_m": 4.5, "waypoint_mode": "field", "target_frame": "global", "yaw_mode": "field_heading", "field_yaw_deg": 0, "tolerance_xy_m": 0.30, "tolerance_z_m": 0.30, "min_hold_updates": 4, "require_velocity_valid": True, "max_horizontal_speed_mps": 0.25, "max_vertical_speed_mps": 0.15, "position_hysteresis_xy_m": 0.20, "position_hysteresis_z_m": 0.10, "horizontal_speed_hysteresis_mps": 0.10, "vertical_speed_hysteresis_mps": 0.05, "reached_updates_decrement": 1, "control_reject_max_updates": 3, "control_reject_timeout_s": 1.0, "max_duration_s": 180.0, "settle_time_s": 1.0, "priority": 5, "key": "goto_drop_center_4_5m"},
                properties={"field_x_m": _NUMBER, "field_y_m": _NUMBER, "x": _NUMBER, "y": _NUMBER, "lat": {"type": ["number", "null"], "minimum": -90, "maximum": 90}, "lon": {"type": ["number", "null"], "minimum": -180, "maximum": 180}, "altitude_m": {"type": "number", "exclusiveMinimum": 0}, "field_yaw_deg": _NUMBER, "yaw_deg": _NUMBER, "target": _TARGET, "target_valid": _BOOLEAN, "skip_if_invalid_target": _BOOLEAN, "tolerance_xy_m": {"type": "number", "exclusiveMinimum": 0}, "tolerance_z_m": {"type": "number", "exclusiveMinimum": 0}, "min_hold_updates": {"type": "integer", "minimum": 1}, "require_velocity_valid": _BOOLEAN, "max_horizontal_speed_mps": {"type": "number", "minimum": 0}, "max_vertical_speed_mps": {"type": "number", "minimum": 0}, "position_hysteresis_xy_m": {"type": "number", "minimum": 0}, "position_hysteresis_z_m": {"type": "number", "minimum": 0}, "horizontal_speed_hysteresis_mps": {"type": "number", "minimum": 0}, "vertical_speed_hysteresis_mps": {"type": "number", "minimum": 0}, "reached_updates_decrement": {"type": "integer", "minimum": 0}, "control_reject_max_updates": {"type": "integer", "minimum": 1}, "control_reject_timeout_s": {"type": "number", "exclusiveMinimum": 0}, "max_duration_s": {"type": "number", "exclusiveMinimum": 0}, "settle_time_s": {"type": "number", "minimum": 0}, "priority": _INTEGER, "key": _STRING, "waypoint_mode": {"type": "string", "enum": ["field", "absolute"]}, "target_frame": {"type": "string", "enum": ["global"]}, "yaw_mode": {"type": "string", "enum": ["field_heading", "hold"]}},
                parameter_aliases={"field_x_m": ("x",), "field_y_m": ("y",), "field_yaw_deg": ("yaw_deg",)},
                parameter_schema_extra={"required": ["altitude_m"], "anyOf": [{"required": ["lat", "lon"]}, {"required": ["field_x_m", "field_y_m"]}, {"required": ["target"]}]},
    ...
    _definition(
        ...
        {"enabled": True, "complete_on_timeout": True, "target_altitude_m": 1.2, "descend_speed_mps": 0.2, "release_deadband_ex": 0.02, "release_deadband_ey": 0.02, "release_target_ex": 0.0, "release_target_ey": 0.0, "release_max_speed_mps": 0.1, "final_settle_time_s": 0.5, "kp_forward": 0.3, "kp_right": 0.3, "final_kp_forward": 0.3, "final_kp_right": 0.3, "ki_forward": 0.0, "ki_right": 0.0, "integral_limit": 0.25, "max_vx_mps": 0.25, "max_vy_mps": 0.25, "final_max_vx_mps": 0.25, "final_max_vy_mps": 0.25, "vx_sign": -1.0, "vy_sign": 1.0, "field_yaw_deg": 0.0, "yaw_speed_deg_s": 20.0, "priority": 5, "key": "drop_1_align"},
        properties={"enabled": _BOOLEAN, "complete_on_timeout": _BOOLEAN, "target_altitude_m": {"type": "number", "exclusiveMinimum": 0}, "descend_speed_mps": {"type": "number", "minimum": 0}, "release_deadband_ex": {"type": "number", "exclusiveMinimum": 0}, "release_deadband_ey": {"type": "number", "exclusiveMinimum": 0}, "release_target_ex": _NUMBER, "release_target_ey": _NUMBER, "release_max_speed_mps": {"type": "number", "exclusiveMinimum": 0}, "final_settle_time_s": {"type": "number", "minimum": 0}, "priority": _INTEGER, "key": _STRING, "max_vx_mps": {"type": "number", "exclusiveMinimum": 0}, "max_vy_mps": {"type": "number", "exclusiveMinimum": 0}, "final_max_vx_mps": {"type": "number", "exclusiveMinimum": 0}, "final_max_vy_mps": {"type": "number", "exclusiveMinimum": 0}, "kp_forward": {"type": "number", "minimum": 0}, "kp_right": {"type": "number", "minimum": 0}, "final_kp_forward": {"type": "number", "minimum": 0}, "final_kp_right": {"type": "number", "minimum": 0}, "ki_forward": {"type": "number", "minimum": 0}, "ki_right": {"type": "number", "minimum": 0}, "integral_limit": {"type": "number", "minimum": 0}, "vx_sign": {"type": "number", "enum": [-1, 1]}, "vy_sign": {"type": "number", "enum": [-1, 1]}, "field_yaw_deg": _NUMBER, "desired_yaw_deg": {"type": ["number", "null"]}, "yaw_speed_deg_s": {"type": "number", "exclusiveMinimum": 0}},
        required_inputs=("scene", "drone.relative_altitude", "field_heading_yaw_rad"), effects=("condition_yaw", "flight_command"), exit_barrier=ExitBarrier.MOTION_STOPPED),
    _definition("payload_release", PayloadReleaseAction, "Release a whitelisted payload servo through execution.", {"enabled": True, "payload_id": "payload_1", "target_id": "target_debug", "servo_outputs": [{"channel": 8, "release_pwm": 1800, "hold_pwm": 1370}], "priority": 3, "release_wait_s": 2, "release_wait_updates": 5, "key": "drop_1_release"}, properties={"enabled": _BOOLEAN, "payload_id": _ID, "target_id": _ID, "servo_outputs": {"type": "array", "minItems": 1, "items": _SERVO_OUTPUT}, "servo_channels": {"type": "array", "minItems": 1, "items": {"type": "integer", "minimum": 1}}, "channels": {"type": "array", "minItems": 1, "items": {"type": "integer", "minimum": 1}}, "channel": {"type": "integer", "minimum": 1}, "release_pwm": {"type": "integer", "minimum": 500, "maximum": 2500}, "hold_pwm": {"type": "integer", "minimum": 500, "maximum": 2500}, "release_wait_updates": {"type": "integer", "minimum": 1}, "release_wait_s": {"type": ["number", "null"], "exclusiveMinimum": 0}, "priority": _INTEGER, "key": _STRING, "release_time": {"type": ["number", "string", "null"]}}, parameter_schema_extra={"required": ["payload_id", "target_id"]}, effects=("set_servo",)),
    _definition("select_drop_targets", SelectDropTargetsAction, "Select ranked drop targets.", {"objects": [], "coordinate_mode": "gps_enu", "target_count": 2, "allow_fewer": True, "fallback_target": {"valid": True, "id": "drop_zone_center", "target_id": "drop_zone_center", "x": 0, "y": 32.5, "status": "fallback_center"}, "single_target_servo_outputs": [{"channel": 8, "release_pwm": 1800, "hold_pwm": 1370}, {"channel": 9, "release_pwm": 1745, "hold_pwm": 1325}], "multi_target_first_servo_outputs": [{"channel": 8, "release_pwm": 1800, "hold_pwm": 1370}], "score_table": {"bucket_1": 500, "bucket_2": 300, "bucket_3": 100, "bucket": 50}, "min_seen_count": 1, "min_raw_count": 1, "min_weight": 0.0, "deduplicate_radius_m": 1.0, "prefer_class_order": ["bucket_1", "bucket_2", "bucket_3", "bucket"], "key": "select_gps_drop_targets"}, properties={"objects": {"type": "array", "items": _LOCALIZED_OBJECT}, "input_key": _STRING, "target_count": {"type": "integer", "minimum": 1}, "min_seen_count": {"type": "integer", "minimum": 0}, "min_raw_count": {"type": "integer", "minimum": 0}, "min_weight": {"type": "number", "minimum": 0}, "deduplicate_radius_m": {"type": "number", "minimum": 0}, "score_table": {"type": "object", "patternProperties": {".*": {"type": "number"}}, "additionalProperties": False}, "prefer_class_order": _STRING_ARRAY, "allow_fewer": _BOOLEAN, "require_local_xy": _BOOLEAN, "fallback_target": _TARGET, "single_target_servo_outputs": {"type": ["array", "null"], "items": _SERVO_OUTPUT}, "multi_target_first_servo_outputs": {"type": ["array", "null"], "items": _SERVO_OUTPUT}, "key": _STRING, "zone_center": {"type": ["array", "null"], "minItems": 2, "maxItems": 2, "items": _NUMBER}, "zone_center_mode": {"type": "string", "enum": ["local", "field"]}, "coordinate_mode": {"type": "string", "enum": ["local", "gps_enu"]}}, output_properties={"selected_targets": {"type": "array", "items": _TARGET}, "target_slots": {"type": "array", "items": _TARGET}, "selected_count": _INTEGER, "candidate_count": _INTEGER, "first_release_servo_outputs": {"type": "array", "items": _SERVO_OUTPUT}, "first_alignment_enabled": _BOOLEAN, "second_alignment_enabled": _BOOLEAN, "second_release_enabled": _BOOLEAN}, required_inputs=("field_reference",)),
    _definition("gps_capture_view", GpsCaptureViewAction, "Project current-view detections to GPS without moving.", {"source_waypoint": "DROP_CENTER", "class_names": ["bucket_1", "bucket_2", "bucket_3", "bucket"], "min_confidence": 0.3, "camera": {"fov_x_deg": 142.964844, "fov_y_deg": 131.870643, "image_x_sign": 1, "image_y_sign": -1, "ground_distance_scale": 0.3333333333333333}}, properties={"class_names": _STRING_ARRAY, "min_confidence": {"type": "number", "minimum": 0}, "source_waypoint": _STRING, "camera": _CAMERA}, output_properties=_GPS_CAPTURE_OUTPUT, required_inputs=("scene", "drone")),
    _definition("gps_fuse_views", GpsFuseViewsAction, "Fuse Mission-captured GPS views.", {"views": [], "class_names": ["bucket_1", "bucket_2", "bucket_3", "bucket"], "fusion": {"cluster_radius_m": 0.65, "outlier_radius_m": 0.65, "min_cluster_size": 1, "min_source_waypoints": 1, "center_weight_power": 1, "max_abs_ex": 0.95, "max_abs_ey": 0.95}}, properties={"views": {"type": "array", "items": {"type": "object", "properties": _GPS_CAPTURE_OUTPUT, "additionalProperties": False}}, "fusion": {"type": "object", "properties": {"cluster_radius_m": {"type": "number", "minimum": 0}, "outlier_radius_m": {"type": "number", "minimum": 0}, "min_cluster_size": {"type": "integer", "minimum": 1}, "min_source_waypoints": {"type": "integer", "minimum": 1}, "center_weight_power": {"type": "number", "minimum": 0}, "min_confidence": {"type": "number", "minimum": 0}, "max_abs_ex": {"type": ["number", "null"]}, "max_abs_ey": {"type": ["number", "null"]}}, "additionalProperties": False}, "class_names": _STRING_ARRAY}, output_properties={"localized_objects": {"type": "array", "items": _LOCALIZED_OBJECT}, "objects": {"type": "array", "items": _LOCALIZED_OBJECT}, "raw_estimates_count": _INTEGER, "count": _INTEGER, "coordinate_frame": {"type": "string", "const": "GLOBAL"}}, required_inputs=("field_reference",)),
