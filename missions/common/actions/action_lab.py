...
_DEFINITIONS = (
    ...
    _definition(
        ...
        {"enabled": True, "complete_on_timeout": True, "target_altitude_m": 1.2, "descend_speed_mps": 0.3, "release_deadband_ex": 0.02, "release_deadband_ey": 0.02, "release_target_ex": 0.0, "release_target_ey": 0.0, "kp_forward": 0.3, "kp_right": 0.3, "max_vx_mps": 0.25, "max_vy_mps": 0.25, "vx_sign": -1.0, "vy_sign": 1.0, "field_yaw_deg": 0.0, "yaw_speed_deg_s": 20.0, "priority": 5, "key": "drop_1_align"},
        properties={"enabled": _BOOLEAN, "complete_on_timeout": _BOOLEAN, "target_altitude_m": {"type": "number", "exclusiveMinimum": 0}, "descend_speed_mps": {"type": "number", "minimum": 0}, "release_deadband_ex": {"type": "number", "exclusiveMinimum": 0}, "release_deadband_ey": {"type": "number", "exclusiveMinimum": 0}, "release_target_ex": _NUMBER, "release_target_ey": _NUMBER, "priority": _INTEGER, "key": _STRING, "max_vx_mps": {"type": "number", "exclusiveMinimum": 0}, "max_vy_mps": {"type": "number", "exclusiveMinimum": 0}, "kp_forward": {"type": "number", "minimum": 0}, "kp_right": {"type": "number", "minimum": 0}, "vx_sign": {"type": "number", "enum": [-1, 1]}, "vy_sign": {"type": "number", "enum": [-1, 1]}, "field_yaw_deg": _NUMBER, "desired_yaw_deg": {"type": ["number", "null"]}, "yaw_speed_deg_s": {"type": "number", "exclusiveMinimum": 0}},
